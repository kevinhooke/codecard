...
String httpRequest(WiFiClient& client, String httpMethod, String url, String host, String btnLabel, int btnFunction){
  ...
  client.println(httpMethod + " " + url + " HTTP/1.0");
  client.println("Host: " + host);
  client.println("X-CODECARD-ID: " + mac);
  client.println("X-CODECARD-BUTTON-LABEL: " + btnLabel);
  client.println("X-CODECARD-BUTTON-FUNCTION: " + String(btnFunction));
...
String secureRequest(String host, int port, String url, String btnLabel, int btnFunction) {
  // url = "/pls/apex/appslab/functions/master";
  ...
  Serial.println(F("Secure Request:"));
  Serial.print(F("  host: "));
  Serial.println(host);
  Serial.print(F("  port: "));
  Serial.println(port);  
